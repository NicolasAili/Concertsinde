		...
		<div id="main">
			...
			<div class="maintxt">
				...
				<div class="blocdeux"> 				
					...
					<p>
						De ce fait, le moyen le plus simple d’être au courant des concerts est soit le bouche à oreille soit de suivre assidument les pages des organisateurs ou  des artistes sur les réseaux sociaux. Or, tout le monde n’a pas forcément le temps de le faire et il est très facile de rater des informations.
					</p>
					<p>
						Le fait aussi que ce milieu dispose de peu de moyens financiers rend la communication souvent légère, voire parfois inexistante. En conséquence, de nombreux concerts se retrouvent en "sous-effectif" du fait que l'ensemble du public n’est pas forcément mis au courant de leur organisation.
					</p>
					<p>
				...
				<div class="bloctrois">
					...
					<p>
						Une fois un concert ajouté, les utilisateurs peuvent le modifier et lorsque toutes informations d'un concert ont été vérifiées (et éventuellement corrigées) par un administrateur, le concert est validé et n’est plus modifiable. Lors de la validation, des points sont attribués aux utilisateurs ayant participés au renseignement du concert (ajout et modifications).
					</p>
					<p>
